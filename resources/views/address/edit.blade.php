    ...
    <form class="form-horizontal" action="/address/{{ $address->id }}" method="POST">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="street_number" name="street_number" value="{{ $address->street_number }}">
          </div>
        </div>
        <div class="form-group">
          <label for="apartment_number" class="col-sm-2 control-label">Numer mieszkania</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="apartment_number" name="apartment_number" value="{{ $address->apartment_number }}">
          </div>
        </div>
        <div class="form-group">
